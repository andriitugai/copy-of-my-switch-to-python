...
def rule2(w_str):
    ''' Return string which consists of symbols ##4 - 6 (included)
    of the string w_str provided '''
...
def rule5(word_list):
    ...
    1) If the length is even the string contains the first letters 
    of the elements of the list
    2) If the length is odd the string contains letters, which nubmer is 
    equal to the number of element in the list '''
...
def hw_1(input_dict):
    ''' Return a string as a result of joining values from input_dict 
